...
OUTPUT_DIR = os.path.join(config.OUTPUT_DIR, "gat_context_acoustic")
CHECKPOINT_DIR = os.path.join(config.CHECKPOINT_DIR, "gat_context_acoustic")
...
best_path = os.path.join(CHECKPOINT_DIR, "gat_context_acoustic_best.pt")
