...
# DropEdge rate — the one addition that survived exploration (see conversation notes /
# archive for the full sweep: GATv2Conv, PairNorm, Jumping Knowledge, positional encoding,
# wav2vec2 layer fusion, and combinations thereof were all tried and did not beat this).
DROP_EDGE_P = 0.15
