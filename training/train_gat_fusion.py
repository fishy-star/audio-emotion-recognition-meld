...
OUTPUT_DIR = os.path.join(config.OUTPUT_DIR, "gat_fusion")
CHECKPOINT_DIR = os.path.join(config.CHECKPOINT_DIR, "gat_fusion")
...
best_path = os.path.join(CHECKPOINT_DIR, "gat_fusion_best.pt")
