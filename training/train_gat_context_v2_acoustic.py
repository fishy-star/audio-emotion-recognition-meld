...
OUTPUT_DIR = os.path.join(config.OUTPUT_DIR, "gat_context_v2_acoustic")
CHECKPOINT_DIR = os.path.join(config.CHECKPOINT_DIR, "gat_context_v2_acoustic")
...
best_path = os.path.join(CHECKPOINT_DIR, "gat_context_v2_acoustic_best.pt")
...
for epoch in range(epochs):
    ...
    for idx in train_sampler:
        ...
        output = model(graph.x, edge_index)
